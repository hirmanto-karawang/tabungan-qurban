...
function loadNilaiEkonomisSapi(tbodyId, tfootId) {
    ...
    tbody.innerHTML = appData.surveySapi.map(s => {
        ...
        const pKepala = n.totalRp > 0 ? Math.round(n.kepala.rp / n.totalRp * 100) : 0;
        const pKaki = n.totalRp > 0 ? Math.round(n.kaki.rp / n.totalRp * 100) : 0;
        const pEkor = n.totalRp > 0 ? Math.round(n.ekor.rp / n.totalRp * 100) : 0;
        const pKulit = n.totalRp > 0 ? Math.round(n.kulit.rp / n.totalRp * 100) : 0;
