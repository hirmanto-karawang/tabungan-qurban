...
git add -A
git commit -m "Fitur: Anggota lihat+ikut+pindah Survey Sapi, kalkulasi Iuran/Daging, kode Survey#, resume peserta+tabungan, estimasi+rencana distribusi daging"
git push
