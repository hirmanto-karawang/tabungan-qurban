...
git add -A
git commit -m "Fitur: Survey Sapi lengkap - Ikut/Pindah anggota, kalkulasi Iuran/Daging, resume peserta+tabungan, edit alokasi distribusi + ringkasan estimasi vs rencana"
git push
